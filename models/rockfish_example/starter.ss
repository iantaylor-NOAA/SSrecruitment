#V3.30.03.07
rockfish_example_dat.ss
rockfish_example_ctl.ss
...
1887 # min yr for sdreport outputs (-1 for styr)
2028 # max yr for sdreport outputs (-1 for endyr; -2 for endyr+Nforecastyrs
